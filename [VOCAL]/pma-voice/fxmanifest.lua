...
shared_script 'config.lua'  -- charger config.lua avant main.lua
...
-- Options de configuration dans txAdmin / ConVars
convar_category 'PMA-Voice' {
    "PMA-Voice Configuration Options",
    {
        ...
        { "Proximity cycle key", "$voice_defaultCycle", "CV_STRING", "B" },
